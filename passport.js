...
module.exports = function (passport) {
    ...
    function (req, username, password, done) {
        ...
        User.findOne({ $or:[{ 'name': username }, { 'email': req.body.email }] }, function (err, user) {
            //User already exists
            if (user != null) {
                ...
                //create
                User.create({ name: username, password: password, email: req.body.email}, function (err, newUser) {
